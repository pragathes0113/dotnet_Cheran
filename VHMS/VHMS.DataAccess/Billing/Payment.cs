...
namespace VHMS.DataAccess.Billing
{
    ...
    {
        public static Collection<Entity.Billing.Payment> GetPayment(int MachinesID)
        {
        ...
        public static Collection<Entity.Billing.Payment> GetLastPaymentDetails(int ID,int MachinesID)
        {
            string sException = string.Empty;
            Database db;
            DataSet dsList = null;
        ...
        public static Entity.Billing.Payment GetPaymentByID(int iPaymentID,int MachinesID)
        {
            string sException = string.Empty;
            Database db;
            Entity.Billing.Payment objPayment = new Entity.Billing.Payment();
        ...
        public static int AddPayment(Entity.Billing.Payment objPayment)
        {
            ...
            try
            {
               ...
               // db.AddInParameter(cmd, "@FK_BankID", DbType.Int32, objPayment.Bank.LedgerID);
                ...
                db.AddInParameter(cmd, "@FK_MachinesID", DbType.Int32, objPayment.Machines.MachinesID);
