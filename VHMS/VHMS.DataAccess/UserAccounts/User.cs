...
namespace VHMS.DataAccess
{
    public class User
    {
        ...
        public static Entity.User GetUserLogin(string sUserName, string sPassword,int MachinesID, string sIPAddress, string clientIp)
        {
            string sException = string.Empty;
            Database db;
            ...
            try
            {
                ...
                db.AddInParameter(cmd, "@FK_MachinesID", DbType.Int32, MachinesID);
                ...
                if (dsList.Tables.Count > 0 && dsList.Tables[0].Rows.Count > 0)
                {
                    foreach (DataRow drrow in dsList.Tables[0].Rows)
                    {
                        ...
                        ObjMachines.MachinesID = Convert.ToInt32(drrow["FK_MachinesID"]);
                        ObjMachines.MachinesName = Convert.ToString(drrow["MachinesName"]);
                        ObjUser.Machines = ObjMachines;
                        ObjEmployee.EmployeeID = Convert.ToInt32(drrow["FK_EmployeeID"]);
                        ObjEmployee.EmployeeName = Convert.ToString(drrow["EmployeeName"]);
        ...
        public static Collection<Entity.User> GetUser()
        {
            string sException = string.Empty;
            Database db;
            DataSet dsList = null;
            ...
            try
            {
                ...
                if (dsList.Tables.Count > 0 && dsList.Tables[0].Rows.Count > 0)
                {
                    foreach (DataRow drData in dsList.Tables[0].Rows)
                    {
                        ...
                        ObjMachines.MachinesID = Convert.ToInt32(drData["FK_MachinesID"]);
        ...
        private static int AddUser(Database oDb, Entity.User objUser, DbTransaction oTrans)
        {
            ...
            try
            {
                ...
                oDb.AddInParameter(cmd, "@FK_MachinesID", DbType.Int32, objUser.Machines.MachinesID);
                oDb.AddInParameter(cmd, "@FK_EmployeeID", DbType.Int32, objUser.Employee.EmployeeID);
