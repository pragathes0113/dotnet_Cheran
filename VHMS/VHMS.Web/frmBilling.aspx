<%@ Page Title="Billing" Language="C#" MasterPageFile="~/VHMSMasterPage.master" AutoEventWireup="true" CodeFile="frmBilling.aspx.cs" Inherits="frmBilling" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="VHMSWebContent" runat="Server">
    ...
    <input type="hidden" id="hdnBillingID" />
    <input type="hidden" id="hdnSalesID" />
    <input type="hidden" id="hdnLastinvoiceDate" />
    <input type="hidden" id="hdnBillingTransID" />
    ...
    <script src="UserDefined_Js/jBilling.js?v=<%= BaseConfig.GetFileHash("UserDefined_Js/jBilling.js") %>" type="text/javascript"></script>
    <script type="text/javascript">
        ...
        var pageUrl = '<%=ResolveUrl("~/frmBilling.aspx") %>';
