...
<head id="Head1" runat="server">
    ...
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no'
        name='viewport' />
    <title>CHERAN BOREWELL | Sign in</title>
...
<body>
        ...
        <div class="container">
            ...
            <div class="col-lg-4 col-md-6 col-sm-8">
                ...
                <div class="row loginbox">
                    <div id="divTitle" runat="server"> <%= Session["MachinesName"].ToString().ToUpper()%> v 1.0.0.0</div>
                    <br />
                    <div class="col-lg-12">
    ...
    <form id="form1" runat="server">
        <div class="container" style="width: 100%; display: flex; height: 100vh; padding: 0px;">
            ...
            <div class="col-sm-6">
                <img src="images/CHERAN.jpg" style="margin: auto; display: block; transform: translate(-50%, -50%); position: absolute; left: 50%; top: 50%; width: 500px;" alt="Logo" />
            </div>
            ...
            <div class="col-sm-3" style="margin-top: 10%">
                ...
                <div class="row loginbox">
                    <div id="divTitle" runat="server">CHERAN BOREWELL  v 1.0.0.0</div>
                    <br />
                    <div class="col-lg-12">
                        <span class="singtext">Sign in </span>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <select id="ddlMachines" name="ddlMachines" class="form-control select2" runat="server" data-placeholder="Select Machines" tabindex="1"></select>
                            ...
                            if (objResponse.Value != null && objResponse.Value != "NoRecord") {
                                ...
                                if (obj.length > 0) {
                                    for (var index = 0; index < obj.length; index++) {
                                        $('#ddlMachines').append("<option value='" + obj[index].MachinesID + "'>" + obj[index].TransportNumber + "-" + obj[index].MachinesName + "</option>");
                                    }
                                }
                                dProgress(false);
                            }
