...
public partial class frmLogin : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!(IsPostBack))
        {
            ...
            if (Request.Cookies["UserName"] != null && Request.Cookies["Password"] != null)
            {
                ...
                ddlMachines.Value = Request.Form["ddlMachines"];
            }
        }
        Assembly assembly = Assembly.Load("App_Code");
        string version = assembly.GetName().Version.ToString();
        divTitle.InnerHtml = "CHERAN BOREWELL " + version;
    }
    protected void btnSignIn_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            int ComID = 0;
            if (!string.IsNullOrEmpty(Request.Form["ddlMachines"]))
            {
                int.TryParse(Request.Form["ddlMachines"], out ComID);
            }
            ...
            var Machinesid = Request.Form["ddlMachines"];
            var MachinesName = Request.Form["ddlname"];
            ...
            if (objUser.UserID > 0)
            {
                ...
                Session["MachinesID"] = objUser.Machines.MachinesID;
                Session["MachinesName"] = objUser.Machines.MachinesName;
