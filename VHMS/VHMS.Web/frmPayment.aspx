                    ...
                    if (data.d != "") {
                        ...
                        if (objResponse.Status == "Success") {
                            if (objResponse.Value != null && objResponse.Value != "NoRecord") {
                                ...
                                if (obj.length > 0) {
                                    $(sControlName).append('<option value="' + '0' + '">' + 'Select Machines' + '</option>');
                                    for (var index = 0; index < obj.length; index++) {
                                        $(sControlName).append("<option value='" + obj[index].MachinesID + "'>" + obj[index].MachinesName + "</option>");
                                    }
                                }
                                dProgress(false);
                            }
